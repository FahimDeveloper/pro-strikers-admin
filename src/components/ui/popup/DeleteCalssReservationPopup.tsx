...
import { useDeleteClassReservationMutation } from "../../../redux/features/reservation/classReservation";

const DeleteClassReservationPopup = ({ id }: { id: string }) => {
...
export default DeleteClassReservationPopup;
