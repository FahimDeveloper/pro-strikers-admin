...
import { useDeleteFacilityReservationMutation } from "../../../redux/features/reservation/facilityReservation";

const DeleteFacilityReservationPopup = ({ id }: { id: string }) => {
...
export default DeleteFacilityReservationPopup;
