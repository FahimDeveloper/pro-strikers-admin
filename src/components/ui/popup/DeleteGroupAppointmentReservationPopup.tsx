...
import { useDeleteAppointmentGroupReservationMutation } from "../../../redux/features/reservation/appointmentGroupReservatonApi";

const DeleteGroupAppointmentReservationPopup = ({ id }: { id: string }) => {
...
export default DeleteGroupAppointmentReservationPopup;
