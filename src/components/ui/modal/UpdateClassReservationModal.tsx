...
import { useUpdateClassReservationMutation } from "../../../redux/features/reservation/classReservation";
import ClassReservationForm from "../form/ClassReservationForm";
import { CiEdit } from "react-icons/ci";

const UpdateClassReservationModal = ({ record }: any) => {
...
export default UpdateClassReservationModal;
